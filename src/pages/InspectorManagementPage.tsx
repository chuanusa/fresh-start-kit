    ...
    <div className="space-y-10">
      <div className="space-y-2">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-semibold uppercase tracking-widest text-accent">Inspector</span>
        </div>
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight gradient-text">檢驗員管理</h2>
      ...
      <Card className="glass-card hover-3d">
        <CardHeader>
          <CardTitle className="flex items-center gap-3 text-base">
            ...
            <span className="font-semibold">檢驗員列表</span>
          </CardTitle>
        </CardHeader>
        <CardContent>
          <div className="text-center py-24">
            <UserCog className="h-16 w-16 mx-auto mb-4 text-muted-foreground/10" />
            <p className="text-lg font-medium text-muted-foreground/60">檢驗員管理</p>
